...
export const ContestsSidebar = (props: Props) => {
  const { filter, userHasSubmissions, cultureIndex } = props;
...
const filters: {
...
}[] = [
  {
    filter: "next-up",
    title: "Top",
    description: `The best submissions so far.`,
    icon: Zap,
  },
  {
    filter: "recent",
  ...
  },
  {
    filter: "auctioned",
    title: "Won",
    description: `All the submissions that have won prizes.`,
    icon: Trophy,
  },
  {
    filter: "hidden",
