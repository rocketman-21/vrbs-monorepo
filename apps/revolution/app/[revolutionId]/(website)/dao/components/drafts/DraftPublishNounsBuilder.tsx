...
import { useCreateProposalNounsBuilder } from "../useCreateProposalNounsBuilder";
...
export const DraftPublishNounsBuilder = (props: Props) => {
  const {
    revolutionId,
    onPublish,
    draft,
  ...
  const { status, propose } = useCreateProposalNounsBuilder({
    address: governanceContract,
    chainId,
    transactions: draft.transactions,
    proposal: `${draft.title}&&${draft.body}`,
