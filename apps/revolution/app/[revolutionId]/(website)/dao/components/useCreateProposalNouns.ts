...
import { nounsDaoLogicV2Abi } from "@cobuild/libs/web3/wagmi";
...
export const useCreateProposalNouns = (props: Props): Response => {
  const { address, onError, onSuccess, proposal, transactions, chainId, onPendingTransaction } =
    props;
